  ...
  return (
    <div className="relative w-full h-full pt-12 overflow-hidden font-sans text-brand-ink gradient-brand-soft">
      ...
      <motion.div
        ...
        className="absolute bottom-0 inset-x-0 bg-white rounded-t-[28px] p-5 pb-8 shadow-[0_-10px_40px_rgba(31,31,46,0.25)]"
      >
        ...
        <div className="flex items-center gap-3">
          <motion.div
            ...
            className="w-20 h-20 rounded-2xl gradient-mint-sky flex items-center justify-center shadow-glow"
          >
        ...
        <div className="mt-4 p-3 rounded-2xl gradient-brand-soft border border-brand-lavender/30">
          <div className="text-[11px] text-brand-ink leading-[15px]">
            A playful frame unlocked with points.
          </div>
        </div>

        <button className="w-full mt-4 py-3.5 rounded-2xl gradient-brand text-white text-[14px] font-bold shadow-glow">
          Unlock and Apply
        </button>
        <button className="w-full mt-2 py-3.5 rounded-2xl bg-white border border-brand-bg text-[14px] font-bold">
          Cancel
        </button>
