    ...
    <div className="relative w-full h-full bg-gradient-to-b from-brand-bg/40 to-white pt-12">
      ...
      <div className="absolute bottom-6 left-4 right-4 flex items-center gap-2">
        <motion.button
          ...
          className="w-11 h-11 rounded-full gradient-brand-soft border border-brand-lavender/30 flex items-center justify-center"
        >
          <svg
            width="18"
            height="18"
        ...
        <motion.button
          ...
          className="w-11 h-11 rounded-full gradient-brand flex items-center justify-center shadow-soft"
        >
          <svg
            width="18"
            height="18"
