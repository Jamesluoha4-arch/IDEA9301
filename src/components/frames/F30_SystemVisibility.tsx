...
const spaces = [
  {
    t: "Exploring shared interests",
    x: 110,
    y: 30,
    w: 180,
    g: "from-brand-purple/20 to-brand-lavender/20",
  },
  {
    t: "Interest Space",
    x: 175,
    ...
    <div className="relative w-full h-full pt-12 pb-20 overflow-y-auto font-sans text-brand-ink gradient-brand-soft">
      ...
      <div className="mx-5 mt-4 bg-white rounded-3xl p-4 shadow-soft border border-brand-bg">
        <div className="flex items-start justify-between">
          <div>
            <div className="text-[14px] font-bold">What I am doing now</div>
            <div className="text-[10px] text-brand-mute mt-0.5 leading-[14px]">
              I only use approved context and show each action here.
            </div>
          </div>
        ...
        <div className="relative mt-3 h-[290px]">
          {spaces.map((s, i) => (
            ...
            >
              <div
                className={`text-[10px] font-bold text-center ${s.active ? "text-white" : "text-brand-ink"}`}
              >
                {s.t}
              </div>
              {s.active && (
                <motion.div
                  ...
                  className="absolute -right-1 -top-1 w-3 h-3 rounded-full bg-brand-pink"
                />
              )}
            </motion.div>
          ))}
      ...
      <div className="mx-5 mt-3 bg-white rounded-2xl px-4 py-3 shadow-soft border border-brand-bg flex items-center gap-3">
        ...
        <div className="flex-1">
          <div className="text-[12px] font-bold">Current AI Activity</div>
          <div className="text-[10px] text-brand-mute">Reviewing approved shared interests</div>
        </div>
      ...
      <div className="mx-5 mt-3 bg-white rounded-2xl shadow-soft border border-brand-bg overflow-hidden">
        <div className="px-4 py-3 flex items-center gap-3 border-b border-brand-bg">
          ...
          <div className="flex-1">
            <div className="text-[12px] font-bold">Recent AI Activity</div>
            <div className="text-[10px] text-brand-mute">3 visible actions today</div>
          </div>
        ...
        {[
          ...
          <div
            key={r.t}
            className="px-4 py-2.5 flex items-center gap-3 border-b border-brand-bg last:border-0"
          >
      ...
      <div className="mx-5 mt-3 mb-4 bg-white rounded-2xl p-4 shadow-soft border border-brand-bg">
        <div className="flex items-center gap-2">
          ...
          <div className="text-[12px] font-bold">Why this matters</div>
        </div>
        <div className="text-[11px] text-brand-mute mt-1.5 leading-[15px]">
          I noticed more conversation-prep activity today. No messages were sent automatically.
        </div>
